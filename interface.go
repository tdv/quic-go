...
type Config struct {
	...
	// ConnectionIDGenerator allows customizing connection ID generation.
	// Connection IDs generated by this implementation must be of constant length.
	// If nil, the default generator is used (4-byte IDs).
	// Chrome uses 8-byte connection IDs.
	ConnectionIDGenerator ConnectionIDGenerator

	// ActiveConnectionIDLimit sets the active_connection_id_limit transport parameter.
	// If 0, the library default is used. Chrome uses 8.
